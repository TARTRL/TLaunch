...
def init_distributed_mode(args):
    ...
    print(f"| distributed init (rank {args.rank}): sahre file: {args.share_file}, local rank: 0, world size:{args.world_size}", flush=True)
...
def main():
    ...
    parser.add_argument("--share_file", type=str, default="", 
                        help="share file used to set up distributed training")
